...
class __TwigTemplate_1e030f1f4b239d3c75abbf9dcec66ecff942390e18b77edec528880ba347acbe extends Template
{
    private $source;
    private $macros = [];
    ...
    public function macro_render_not_table_triggered_handlers($__handlers__ = null, ...$__varargs__)
    {
        ...
        <table>
            ...
            <tr>
                ...
                <th>Handler</th>";
                // line 42
                if ((((isset($context["called"]) || array_key_exists("called", $context))) ? (_twig_default_filter((isset($context["called"]) || array_key_exists("called", $context) ? $context["called"] : (function () { throw new RuntimeError('Variable "called" does not exist.', 42, $this->source); })()), false)) : (false))) {
                    // line 43
                    echo "<th>Calls</th>
...
{%- macro render_table_triggered_handlers(handlers) -%}
    ...
    {%- endfor -%}
{%- endmacro -%}
", "@JMSSerializer/Collector/handlers.html.twig", "C:\\Users\\azizm\\Desktop\\SEM2\\PIDEV\\Foodine_PIDEV\\vendor\\jms\\serializer-bundle\\Resources\\views\\Collector\\handlers.html.twig");
    }
}
