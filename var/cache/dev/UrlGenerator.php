...
return [
    ...
    'addRevJson' => [[], ['_controller' => 'App\\Controller\\FrontController::addRevJson'], [], [['text', '/addRevJson']], [], []],
    'deleteRevJson' => [['id'], ['_controller' => 'App\\Controller\\FrontController::deleteReviewJson'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/deleteRevJson']], [], []],
    'showRevJson' => [[], ['_controller' => 'App\\Controller\\FrontController::allReviewsJson'], [], [['text', '/showRevJson']], [], []],
    ...
    'resetPasswordJSON' => [[], ['_controller' => 'App\\Controller\\SecurityController::resetPassJSON'], [], [['text', '/resetPasswordJSON']], [], []],
    ...
    'deleteUserJson' => [['id'], ['_controller' => 'App\\Controller\\SecurityController::deleteUserJson'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/deleteUserJson']], [], []],
    'roleJson' => [['id'], ['_controller' => 'App\\Controller\\SecurityController::ModifierUser'], [], [['variable', '/', '[^/]++', 'id'], ['text', '/roleJson']], [], []],
