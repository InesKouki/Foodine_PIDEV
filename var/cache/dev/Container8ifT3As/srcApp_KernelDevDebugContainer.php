...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('T8f+oLbvrl', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('jQAxZbcQS+', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9vkyaeIYPu', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('IJH6PP3f+P', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8NtYmumbnL', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('r1vrU7qPmq', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('YbBHnGSbb4', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'upload_directory' => (\dirname(__DIR__, 4).'/public/front/assets/img'),
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHoldere6035 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerab75c = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties30dd8 = [
        
    ];

    public function getConnection()
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'getConnection', array(), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'getMetadataFactory', array(), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'getExpressionBuilder', array(), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'beginTransaction', array(), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'getCache', array(), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->getCache();
    }

    public function transactional($func)
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'transactional', array('func' => $func), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'wrapInTransaction', array('func' => $func), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'commit', array(), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->commit();
    }

    public function rollback()
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'rollback', array(), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'getClassMetadata', array('className' => $className), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'createQuery', array('dql' => $dql), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'createNamedQuery', array('name' => $name), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'createQueryBuilder', array(), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'flush', array('entity' => $entity), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'clear', array('entityName' => $entityName), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->clear($entityName);
    }

    public function close()
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'close', array(), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->close();
    }

    public function persist($entity)
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'persist', array('entity' => $entity), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'remove', array('entity' => $entity), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'refresh', array('entity' => $entity), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'detach', array('entity' => $entity), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'merge', array('entity' => $entity), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'getRepository', array('entityName' => $entityName), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'contains', array('entity' => $entity), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'getEventManager', array(), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'getConfiguration', array(), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'isOpen', array(), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'getUnitOfWork', array(), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'getProxyFactory', array(), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'initializeObject', array('obj' => $obj), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'getFilters', array(), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'isFiltersStateClean', array(), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'hasFilters', array(), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return $this->valueHoldere6035->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerab75c = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHoldere6035) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHoldere6035 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHoldere6035->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, '__get', ['name' => $name], $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        if (isset(self::$publicProperties30dd8[$name])) {
            return $this->valueHoldere6035->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHoldere6035;
    ...
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;
    ...
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, '__isset', array('name' => $name), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;
    ...
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, '__unset', array('name' => $name), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;
    ...
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, '__clone', array(), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        $this->valueHoldere6035 = clone $this->valueHoldere6035;
    }

    public function __sleep()
    {
        $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, '__sleep', array(), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;

        return array('valueHoldere6035');
    }
    ...
    {
        $this->initializerab75c = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerab75c;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerab75c && ($this->initializerab75c->__invoke($valueHoldere6035, $this, 'initializeProxy', array(), $this->initializerab75c) || 1) && $this->valueHoldere6035 = $valueHoldere6035;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHoldere6035;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHoldere6035;
    }
