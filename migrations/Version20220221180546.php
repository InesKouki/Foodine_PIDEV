 ...
 */
final class Version20220221180546 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recette CHANGE imagerecette imagerecette VARCHAR(255) DEFAULT NULL');
    }
