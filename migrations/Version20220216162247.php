 ...
 */
final class Version20220216162247 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product CHANGE quantitie quantitie INT NOT NULL');
    }
