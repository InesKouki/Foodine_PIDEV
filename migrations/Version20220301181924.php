 ...
 */
final class Version20220301181924 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE livraison CHANGE phone phone INT DEFAULT NULL');
    }
