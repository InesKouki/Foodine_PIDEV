 ...
 */
final class Version20220213194301 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product CHANGE price price VARCHAR(50) DEFAULT NULL');
    }
