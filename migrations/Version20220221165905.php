 ...
 */
final class Version20220221165905 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product CHANGE quantitie quantitie INT NOT NULL, CHANGE price price INT DEFAULT NULL');
    }
