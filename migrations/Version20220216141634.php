 ...
 */
final class Version20220216141634 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product CHANGE name name VARCHAR(50) NOT NULL, CHANGE quantitie quantitie VARCHAR(255) NOT NULL, CHANGE price price VARCHAR(50) NOT NULL, CHANGE image image VARCHAR(50) NOT NULL');
    }
