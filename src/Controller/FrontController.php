...
class FrontController extends AbstractController
{
     ...
     * @Route("/", name="front")
     */
    public function index(EvenementRepository $repo,ReviewRepository $repository): Response
    {
        $event=$repo->getActiveEvents();
        $rev=$repository->findRevMax();
        return $this->render('front/homeFront.html.twig', ['activeEvents' => $event,'rev'=>$rev]);
    }
